...
VL_ATTR_COLD void Vlng___024root___eval_initial__TOP(Vlng___024root* vlSelf) {
    ...
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.chargePump__DOT__state = 2U;
    vlSelfRef.test = 0U;
}
...
VL_ATTR_COLD void Vlng___024root___ctor_var_reset(Vlng___024root* vlSelf) {
    ...
    vlSelf->chargePump__DOT__state = VL_RAND_RESET_I(4);
    vlSelf->chargePump__DOT__count = VL_RAND_RESET_I(6);
    vlSelf->chargePump__DOT__count2 = VL_RAND_RESET_I(6);
