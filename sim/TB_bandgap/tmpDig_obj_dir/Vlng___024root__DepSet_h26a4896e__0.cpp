...
VL_INLINE_OPT void Vlng___024root___nba_sequent__TOP__0(Vlng___024root* vlSelf) {
    ...
    if (vlSelfRef.rst) {
        ...
        if ((0U == (IData)(vlSelfRef.tmpDig__DOT__setupDone))) {
            if ((7U < (IData)(vlSelfRef.tmpDig__DOT__count))) {
                ...
                if (vlSelfRef.cmp) {
                    ...
                    if ((0U == (IData)(vlSelfRef.tmpDig__DOT__setupDone))) {
                        ...
                        if ((6U == (IData)(vlSelfRef.tmpDig__DOT__setupCount))) {
            ...
            if (vlSelfRef.tmpDig__DOT__intCmp) {
        ...
        } else if ((0xfU < (IData)(vlSelfRef.tmpDig__DOT__count))) {
            vlSelfRef.PI2 = 0U;
            __Vdly__tmpDig__DOT__count = 0U;
            __Vdly__tmpDig__DOT__state = 1U;
        } else {
        ...
        if ((7U < (IData)(vlSelfRef.tmpDig__DOT__count))) {
            vlSelfRef.PII2 = 0U;
            __Vdly__tmpDig__DOT__count = 0U;
            __Vdly__tmpDig__DOT__state = ((0U < (IData)(vlSelfRef.tmpDig__DOT__setupDone))
                                           ? ((1U == (IData)(vlSelfRef.tmpDig__DOT__setupDone))
                                               ? 5U
                                               : ((IData)(vlSelfRef.tmpDig__DOT__Hcharged)
                                                   ? 4U
                                                   : 3U))
                                           : 2U);
        } else if ((0U == (IData)(vlSelfRef.tmpDig__DOT__count))) {
        ...
        if ((4U < (IData)(vlSelfRef.tmpDig__DOT__count))) {
            __Vdly__tmpDig__DOT__count = 0U;
            vlSelfRef.tmpDig__DOT__intCmp = vlSelfRef.cmp;
        ...
        if ((0xfU > (IData)(vlSelfRef.tmpDig__DOT__setupDone))) {
