...
void Vlng___024root___eval_triggers__act(Vlng___024root* vlSelf) {
    ...
    vlSelfRef.__VactTriggered.set(1U, ((((IData)(vlSelfRef.cmp) 
                                        ...
                                        | ((IData)(vlSelfRef.tmpDig__DOT__afterBlank) 
                                           != (IData)(vlSelfRef.__Vtrigprevexpr___TOP__tmpDig__DOT__afterBlank__0))) 
                                       | ((IData)(vlSelfRef.tmpDig__DOT__snk_ctrl) 
                                          != (IData)(vlSelfRef.__Vtrigprevexpr___TOP__tmpDig__DOT__snk_ctrl__0))));
    vlSelfRef.__VactTriggered.set(2U, ((((IData)(vlSelfRef.cmp) 
                                         != (IData)(vlSelfRef.__Vtrigprevexpr___TOP__cmp__0)) 
                                        | ((IData)(vlSelfRef.tmpDig__DOT__afterBlank) 
                                           != (IData)(vlSelfRef.__Vtrigprevexpr___TOP__tmpDig__DOT__afterBlank__0))) 
                                       | ((IData)(vlSelfRef.tmpDig__DOT__src_ctrl) 
                                          != (IData)(vlSelfRef.__Vtrigprevexpr___TOP__tmpDig__DOT__src_ctrl__0))));
