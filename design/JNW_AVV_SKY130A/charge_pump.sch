...
C {JNW_TR_SKY130A/JNWTR_CAPX1.sym} -230 -130 0 0 {name=x1[4:0]}
...
C {JNW_TR_SKY130A/JNWTR_RPPO2.sym} -420 -340 0 0 {name=x1 }
C {JNW_TR_SKY130A/JNWTR_RPPO2.sym} -420 -160 0 0 {name=x10 }
