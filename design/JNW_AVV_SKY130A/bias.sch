...
N -100 -110 -100 -30 {
lab=vss}
N -100 130 -60 130 {lab=vss}
N -100 50 -100 130 {
lab=vss}
N -100 50 -60 50 {lab=vss}
N -100 -30 -100 50 {
lab=vss}
N 30 -310 110 -310 {lab=tg_top}
N -40 -150 -40 210 {lab=tg_bot}
...
C {JNW_TR_SKY130A/JNWTR_RPPO16.sym} -40 -150 1 1 {name=x1 }
