...
C {devices/lab_wire.sym} 890 -320 0 0 {name=p15 sig_type=std_logic lab=vdd}
C {devices/lab_wire.sym} 890 -200 0 1 {name=p16 sig_type=std_logic lab=vss}
...
C {devices/lab_wire.sym} 840 -240 0 0 {name=p20 sig_type=std_logic lab=sample}
C {JNW_AVV_SKY130A/DFF.sym} 890 -260 0 0 {name=x3}
