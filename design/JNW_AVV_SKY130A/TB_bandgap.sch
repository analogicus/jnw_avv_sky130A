...
C {devices/vsource.sym} 1440 -790 0 0 {name=ibias_n value=0 savecurrent=false}
C {devices/vsource.sym} 1660 -760 0 0 {name=ibias_p value=0 savecurrent=false}
...
C {devices/ipin.sym} 1220 -790 2 0 {name=p15 lab=preChrg}
