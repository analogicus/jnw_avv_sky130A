...
N 1540 -700 1600 -700 {
lab=cmp}
N 1250 -730 1280 -730 {lab=vip}
N 1250 -670 1280 -670 {lab=vin}
...
N 510 -150 570 -150 {lab=vss}
N 570 -185 570 -150 {lab=vss}
N 510 -220 510 -150 {lab=vss}
N 410 -220 470 -220 {lab=s_CapRst}
N 570 -300 570 -255 {lab=#net1}
N 570 -300 610 -300 {lab=#net1}
N 510 -300 510 -250 {lab=#net1}
N 510 -300 570 -300 {lab=#net1}
N 510 -350 510 -300 {lab=#net1}
N 510 -440 510 -410 {lab=Iptat}
N 510 -440 570 -440 {lab=Iptat}
N 710 -300 770 -300 {lab=vip}
N 890 -310 940 -310 {lab=vref}
N 1040 -310 1090 -310 {lab=vin}
...
C {devices/lab_wire.sym} 1380 -830 0 0 {name=p7 sig_type=std_logic lab=vdd}
C {devices/lab_wire.sym} 610 -1220 0 0 {name=p8 sig_type=std_logic lab=vdd}
C {devices/lab_wire.sym} 1380 -570 0 0 {name=p9 sig_type=std_logic lab=vss}
...
C {devices/lab_wire.sym} 1510 -600 0 0 {name=p33 sig_type=std_logic lab=pbias}
...
C {devices/lab_wire.sym} 1490 -790 0 1 {name=p35 sig_type=std_logic lab=cmp_p2}
C {devices/lab_wire.sym} 1450 -830 0 1 {name=p37 sig_type=std_logic lab=cmp_p1}
...
C {JNW_AVV_SKY130A/CMP_v2.sym} 1270 -580 0 0 {name=x1}
...
C {devices/lab_wire.sym} 1270 -730 0 0 {name=p40 sig_type=std_logic lab=vip}
C {devices/lab_wire.sym} 1270 -670 0 0 {name=p48 sig_type=std_logic lab=vin}
...
C {devices/lab_wire.sym} 1570 -700 0 1 {name=p62 sig_type=std_logic lab=cmp}
...
C {JNW_TR_SKY130A/JNWTR_CAPX4.sym} 570 -195 0 0 {name=x1[30:0]}
C {JNW_ATR_SKY130A/JNWATR_NCH_2C1F2.sym} 470 -220 0 0 {name=x7 }
C {devices/lab_wire.sym} 450 -220 0 0 {name=p58 sig_type=std_logic lab=s_CapRst}
C {JNW_ATR_SKY130A/JNWATR_PCH_2C1F2.sym} 470 -380 0 0 {name=x8 }
C {devices/lab_wire.sym} 470 -380 0 0 {name=p63 sig_type=std_logic lab=s_CapRst}
C {devices/lab_wire.sym} 510 -380 0 1 {name=p64 sig_type=std_logic lab=vdd}
C {devices/lab_wire.sym} 520 -440 0 1 {name=p65 sig_type=std_logic lab=Iptat}
C {JNW_TR_SKY130A/JNWTR_TGX2_CV.sym} 600 -300 0 0 {name=x9 }
C {devices/lab_wire.sym} 690 -250 0 1 {name=p66 sig_type=std_logic lab=vss}
C {devices/lab_wire.sym} 690 -340 0 1 {name=p67 sig_type=std_logic lab=vdd}
C {devices/lab_wire.sym} 760 -300 0 0 {name=p69 sig_type=std_logic lab=vip}
C {JNW_TR_SKY130A/JNWTR_TGX2_CV.sym} 930 -310 0 0 {name=x10 }
C {devices/lab_wire.sym} 1020 -260 0 1 {name=p68 sig_type=std_logic lab=vss}
C {devices/lab_wire.sym} 1020 -350 0 1 {name=p70 sig_type=std_logic lab=vdd}
C {devices/lab_wire.sym} 900 -310 0 1 {name=p71 sig_type=std_logic lab=vref}
C {devices/lab_wire.sym} 1060 -310 0 1 {name=p72 sig_type=std_logic lab=vin}
C {devices/lab_wire.sym} 990 -350 0 0 {name=p73 sig_type=std_logic lab=s_Ref2CMP}
C {devices/lab_wire.sym} 660 -340 0 0 {name=p74 sig_type=std_logic lab=s_Cap2CMP}
C {devices/lab_wire.sym} 530 -150 0 1 {name=p75 sig_type=std_logic lab=vss}
